...
// Define the correct type for PageProps in Next.js 15+ (Layout/Page params are Promises in some contexts, but usually params is an object in basic dynamic routes. 
// However, strictly typing simple params is safer.)
interface PageProps {
...
export default async function OriginPage({ params }: PageProps) {
    ...
    return <OriginContent origin={origin} />;
}

// Client Component for Animations
function OriginContent({ origin }: { origin: typeof origins[0] }) {
