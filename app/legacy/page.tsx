    ...
    return (
        <main className="w-full bg-[#FBFBF9] dark:bg-[#0A0A0B] min-h-screen">
            ...
            <section className="pt-48 pb-24 px-6 md:px-24">
                <h1 className="text-5xl md:text-8xl font-light serif mb-12">Legacy</h1>
                <p className="text-xl opacity-60 leading-relaxed max-w-2xl serif italic">
                    Our archives are a testament to patience.
                </p>
                <div className="mt-24 h-[50vh] w-full bg-zinc-100 dark:bg-zinc-900 rounded-[40px] flex items-center justify-center">
