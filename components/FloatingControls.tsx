    ...
    return (
        <div className="fixed bottom-8 right-8 z-[900] flex items-center gap-4 pointer-events-none">
            ...
            <button
                ref={scrollBtnRef}
                onClick={scrollToTop}
                className={`pointer-events-auto group relative w-12 h-12 md:w-14 md:h-14 flex items-center justify-center rounded-full bg-white dark:bg-[#1A1A1A] text-black dark:text-white shadow-2xl transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)]
            ...
            >
                ...
                {/* Arrow Icon */}
                <span className="relative z-10 text-xl group-hover:-translate-y-1 transition-transform duration-300">
                    ↑
                </span>
            </button>
            ...
            <a
                ...
                className="pointer-events-auto group relative w-12 h-12 md:w-14 md:h-14 flex items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition-transform duration-300 hover:scale-110 hover:shadow-[#25D366]/40"
                aria-label="Chat on WhatsApp"
            >
                {/* Ripple Effect */}
                <div className="absolute inset-0 rounded-full border border-[#25D366] animate-[ping_2s_cubic-bezier(0,0,0.2,1)_infinite] opacity-50" />
