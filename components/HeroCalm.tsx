            ...
            <div className="relative z-10 w-full max-w-[1600px] px-12 md:px-32">
                <div className="flex flex-col gap-[var(--space-12)]">
                    <div className="flex items-end justify-between">
                        <h1 className={`text-[15vw] md:text-[12vw] font-light serif leading-[0.8] tracking-tight uppercase transition-all duration-[var(--duration-slow)] ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
                            Rare
                            <span className="italic ml-6 text-[#b5a16d]/80 lowercase">by nature</span>
                        </h1>
                        <div className={`hidden lg:flex flex-col items-end gap-6 mb-12 transition-all duration-[var(--duration-slow)] ${mounted ? 'opacity-40 translate-y-0' : 'opacity-0 translate-y-3'}`}>
                            ...
                            <div className="text-[9px] tracking-[1.2em] uppercase">Archive No. 001</div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start justify-between">
                        <p className={`hidden lg:block text-[11px] tracking-[0.6em] uppercase opacity-40 max-w-[260px] leading-[2] transition-all duration-[var(--duration-slow)] ${mounted ? 'opacity-40 translate-y-0' : 'opacity-0 translate-y-3'}`}>
                            A quiet conversation between nature and intent.
                        </p>
                        <h1 className={`text-[15vw] md:text-[12vw] font-light serif leading-[0.8] tracking-tight uppercase text-right transition-all duration-[var(--duration-slow)] ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
                            <span className="italic mr-2">Craf</span>ted
                        </h1>
                    </div>
                    <div className="absolute bottom-20 left-1/2 -translate-x-1/2 flex flex-col items-center opacity-30">
                        ...
                        <span className="mt-8 text-[8px] tracking-[1.4em] uppercase">Archives</span>
                    </div>
                </div>
            </div>
        </section>
