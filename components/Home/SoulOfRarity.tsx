...
const SoulOfRarity: React.FC = () => {
    return (
        <section className="relative min-h-screen py-32 md:py-48 px-6 md:px-24 flex flex-col justify-center overflow-hidden bg-secondary dark:bg-[#0A0908] text-[#1A1A1A] dark:text-[#FBFBF9]">
                ...
                <div className="flex flex-col md:flex-row items-center gap-16 md:gap-32">
                    ...
                    <div className="w-full md:w-1/2 flex flex-col justify-center">
                        <div className="flex items-center gap-6 mb-12 opacity-40">
                            <span className="text-[10px] tracking-[0.4em] uppercase font-sans font-medium text-[#b5a16d]">Volume 04 / The Raw</span>
                            <div className="w-20 h-px bg-[#b5a16d]/30" />
                        </div>
