      ...
      <div className="flex flex-col md:flex-row justify-between gap-16 mb-32">
        <div className="max-w-md">
          ...
          >
            ...
            <style>{`.group:hover span, .group:hover svg { color: white !important; } .dark .group:hover span, .dark .group:hover svg { color: black !important; }`}</style>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 md:gap-24">
          <div className="flex flex-col gap-6">
            ...
            <Link to="/" className="text-sm hover:opacity-50">Heritage</Link>
            <Link to="/" className="text-sm hover:opacity-50">Craftsmanship</Link>
            <Link to="/" className="text-sm hover:opacity-50">Archive</Link>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <Link to="/book" className="text-sm hover:opacity-50">Booking</Link>
          </div>
